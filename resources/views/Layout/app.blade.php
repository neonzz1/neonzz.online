...
<!-- Nav Item - User Information -->
	...
	<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		...
		<div class="container-fluid w3-border-bottom w3-border-light-grey w3-padding-custom">
			...
			@endauth
	 		<header class="w3-display-container w3-content1 w3-wide" style="max-width:1500px;" id="home">
        	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		    	<img class="w3-image mb-0" src="../img/Websitebackground.png" alt="logo" width="950" height="1000" id="headerimage" style="margin-left:200px">
			</div>
			<div class="w3-display-topmiddle">
				<h1 class="w3-small w3-text-grey w3-content2"><span class="w3-opacity-min">Welcome to my site for my code!</span></h1>
		</div>
	 </header>
	 <!-- Page content -->
