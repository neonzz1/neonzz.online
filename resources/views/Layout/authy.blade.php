...
<!-- Topbar Navbar -->
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow">
							...
							@if (Route::has('login'))
								...
								<a class="dropdown-item" href="logout.php" data-toggle="modal" data-target="#loginModal">
	...
	<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
		...
		<div class="container-fluid w3-border-bottom w3-border-light-grey w3-padding-custom" id="CssChange" name="CssChange">
	 		<h3 class="w3-medium w3-text-black"><span class="w3-opacity-min">Welcome<p class="w3-opacity-min" id="uname"></span></h3>
