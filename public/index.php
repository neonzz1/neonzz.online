                  ...
                  <ol class="flex items-center space-x-4">
                    ...
                    <li>
                      <div class="flex items-center">
                        ...
                        <a href="https://forge.laravel.com/servers/445336" target="_blank" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">NEONZZ (139.162.203.216)</a>
                      </div>
                    </li>
                    ...
                    <li>
                      <div class="flex items-center">
                        ...
                        <a href="https://forge.laravel.com/servers/445336/sites/1281867" target="_blank" aria-current="page" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">N3ONZZ.ONLINE</a>
                      </div>
                    </li>
                  </ol>
                </nav>
                                        ...
                                        <dl class="mt-10 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-1 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-3 lg:gap-x-8">
                                            <div class="flex">
                                                ...
                                                <div class="ml-3">
                                                    ...
                                                    <dd class="mt-2 text-base text-gray-500">
                                                        <a href="https://forge.laravel.com/servers/445336/sites/1281867#/apps" target="_blank">
                                            ...
                                            <div class="flex">
                                                ...
                                                <div class="ml-3">
                                                    ...
                                                    <dd class="mt-2 text-base text-gray-500">
                                                        <a href="https://forge.laravel.com/servers/445336/sites/1281867#/application" target="_blank">
                                                            <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                            ...
                            <div class="bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
                                ...
                                <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://laracasts.com/series/learn-laravel-forge" target="_blank">Video Tutorials</a></div>
                                    </div>
                                    ...
                                    <div class="ml-12">
                                        ...
                                        <a href="https://laracasts.com/series/learn-laravel-forge" target="_blank">
                                            <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                                ...
                                <div class="p-6 border-t border-gray-200">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://forge.laravel.com/servers/445336/sites/1281867#/certificates" target="_blank">SSL Certificates</a></div>
                                    </div>
                                    ...
                                    <div class="ml-12">
                                        ...
                                        <a href="https://forge.laravel.com/servers/445336/sites/1281867#/certificates" target="_blank">
                                            <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                                                <div>Install SSL</div>
